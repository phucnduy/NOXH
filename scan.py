...
SCAN_BATCHES = [
    ...
    (
        ...
        [
            ...
            "sxd.tayninh.gov.vn",
            # Danh sách tổng hợp chất lượng cao
            ...
            "market.vinhomes.vn/blog/danh-sach-8-du-an-nha-o-xa-hoi-tp-hcm-mo-ban",
        ],
    ),
    (
...
def build_prompt(provinces: list[str], sources: list[str]) -> str:
    ...
    lines = [
        ...
        "",
        f"Nguon chinh thuc va URL cu the (doc truc tiep neu co the): {src_str}",
        "Nguon bao va tong hop them: cafef.vn, vnexpress.net, tienphong.vn, baoxaydung.vn,",
        "           laodong.vn, dantri.vn, batdongsan.com.vn, cafeland.vn,",
        "           nguoiduatin.vn, reatimes.vn, nhadatmoi.com.vn,",
        "           annhome.vn, thuvienphapluat.vn, market.vinhomes.vn",
        "",
...
def main():
    ...
    # 2b. Geocoding tự động (bỏ qua khi DRY_RUN)
    if not DRY_RUN:
